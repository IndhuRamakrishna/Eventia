...
<body>
        <h1 class="head">Here are some amazing Reception Event Designs..!!</h1>
        
    <div class="div1">
            <a href="r1.php"><img class="img1" src="hall\changedwhiteheaven1.jpg" alt=""></a>
            <h2 class="name1">White Heaven</h2>
            <p class="p1"><b> Price:Rs. 15,000</b></p>
            <a href="r2.php"><img class="img2" src="hall\64de3796c77ab4b24bb8e430e4745732.jpg" alt=""></a>
            <h2 class="name2">La Rose</h2>
            <p  class="p2"><b> Price:Rs. 10,000</b></p>
            <a href="r3.php"><img class="img3" src="hall\changedwillowgarden2.h" alt=""></a>
            <h2 class="name3">Willow Garden</h2>
            <p  class="p3"><b> Price:Rs. 5,000</b></p>
            <a href="r4.php"><img class="img4" src="hall\a0c25147b23c2f6c801d214ae6fa5524.jpg" alt=""></a>
            <h2 class="name4">Paradise</h2>
            <p  class="p4"><b> Price:Rs. 20,000</b></p>
            <a href="r5.php"><img class="img5" src="hall\garden.jpg" alt=""></a>
            <h2 class="name5">Floreshia</h2>
