<html>
       ...
       .hp{
        ...
        <body>
                <h1 class="head">Here are some amazing Birthday Event Designs..!!</h1>
                
            <div class="div1">
                    <a href="b1.php"><img class="img1" src="hall\changedpoodleparty.jpg" alt=""></a>
                    <h2 class="name1">Poodle Party</h2>
                    <p class="p1"><b> Price:Rs. 15,000</b></p>
                    <a href="b2.php"><img class="img2" src="hall\changedbabyparty.jpg" alt=""></a>
                    <h2 class="name2">Baby Party</h2>
                    <p  class="p2"><b> Price:Rs. 10,000</b></p>
                    <a href="b3.php"><img class="img3" src="hall\changedbash1.jpg" alt=""></a>
                    <h2 class="name3">The Bash</h2>
                    <p  class="p3"><b> Price:Rs. 5,000</b></p>
                    <a href="b4.php"><img class="img4" src="hall\b6.jpg" alt=""></a>
                    <h2 class="name4">Blue Whale</h2>
                    <p  class="p4"><b> Price:Rs. 20,000</b></p>
                    <a href="b5.php"><img class="img5" src="hall\changedrockstarparty1.jpg" alt=""></a>
                    <h2 class="name5">Rockstar Party </h2>
