<html>
       ...
       .hp{
        ...
        <body>
                <h1 class="head">Here are some amazing Anniversary Event Designs..!!</h1>
                
            <div class="div1">
                    <a href="a1.php"><img class="img1" src="hall\changedlanternlove1.jpg" alt=""></a>
                    <h2 class="name1">Lantern love</h2>
                    <p class="p1"><b> Price:Rs. 15,000</b></p>
                    <a href="a2.php"><img class="img2" src="hall\changedroyaltouch.jpg" alt=""></a>
                    <h2 class="name2">Royal Touch</h2>
                    <p  class="p2"><b> Price:Rs. 10,000</b></p>
                    <a href="a3.php"><img class="img3" src="hall\changedwhitepalace.jpg" alt=""></a>
                    <h2 class="name3">White Palace</h2>
                    <p  class="p3"><b> Price:Rs. 5,000</b></p>
                    <a href="a4.php"><img class="img4" src="hall\e9f41fccc34debc89383d5d63116ae04.jpg" alt=""></a>
                    <h2 class="name4">Fire Fly</h2>
                    <p  class="p4"><b> Price:Rs. 20,000</b></p>
                    <a href="a5.php"><img class="img5" src="hall\a2.jpg" alt=""></a>
                    <h2 class="name5">Jenevieve</h2>
